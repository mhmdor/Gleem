...
<body>
  ...
  <div class="overview d-flex">
    ...
    <div class="sidebar d-flex flex-column">
      ...
      <div class="logout d-flex align-items-center gap-2">
        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
          <path d="M14 5L12.59 6.41L14.17 8H6V10H14.17L12.59 11.58L14 13L18 9L14 5ZM2 2H9V0H2C0.9 0 0 0.9 0 2V16C0 17.1 0.9 18 2 18H9V16H2V2Z" fill="currentColor"/>
        </svg>
        <a href="/">logout</a>
      </div>
    </div>
    ...
    <div class="page">
      ...
      <div class="graphs pt-3 ps-3 pe-5 d-flex gap-3">
        <div class="pieChart" id="pieChart">
          <h2>Overview</h2>
        </div>
        <div class="numbersChart" id="numbersChart">
          <h2>Number Of clients</h2>
        </div>
      </div>

      <div class="latest pt-3 ps-3 pe-5 d-flex gap-3 mb-5">
        <div class="companies">
          <h2 class="mb-3">Latest Companies</h2>
          <div class="scroll">
        ...
        <div class="clients">
          <h2 class="mb-3">latest individual clients</h2>
          <div class="scroll">
            <table class="bg-white">
              <thead>
                <th>Date</th>
  ...
  <script>
    var data = [{
      values: [20, 140, 55],
      labels: ['Reject', 'Pending', 'Complete Visa'],
      type: 'pie'
    }];
  ...
  <script>
    var trace1 = {
      ...
      y: [10, 20, 30, 40, 50 ,60 ,70 ,80 , 90 , 70 , 50 , 20],
      type: 'bar',
      marker: {
        color: '#F2921F',
      }
    ...
    Plotly.newPlot('numbersChart', data );
  </script>
