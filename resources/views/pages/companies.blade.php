...
document.getElementById('logout-form').submit();">
        ...
        <div class="page">
            ...
            <div class="latest pt-4 ps-3 pe-5 d-flex gap-3 mb-5">
                <div class="clients">

                    <div class="head d-flex align-items-center justify-content-between mb-4">
                        <div class="sort d-flex align-items-center gap-2">
                            <h4>sort by:</h4>
                            <select name="" id="" class="py-3 px-2">
                                <option value="" selected disabled>By default</option>
                                <option value="">By default 2</option>
                                <option value="">By default 3</option>
                            </select>
                        </div>
                        <div class="addClient">
                            <a href="{{ route('createCompany') }}" class="d-flex align-items-center gap-2">
                    ...
                    <div class="companies-boxes">

                        @foreach ($Companies as $Company)
                            <div class="box bg-white d-flex flex-column p-4 pb-5">
                                <div class="image mb-4"><img
                                        src="{{ asset('assets/uploads/logos/' . $Company->photo) }}" alt="">
                                </div>
                                <h2 class="mb-2">{{ $Company->companyName }}</h2>
                                <h3 class="mb-5">80 clients</h3>
                                <a href="/" class="mb-3">View clients list</a>
                                <a href="{{ route('getSingleCompany', $Company->id) }}">View details</a>
                            </div>
                        @endforeach
