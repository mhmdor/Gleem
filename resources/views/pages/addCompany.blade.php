    ...
    <div class="overview clients d-flex">
        ...
        <div class="sidebar d-flex flex-column">
            ...
            <div class="items d-flex flex-column gap-2">
                ...
                <a href="{{ route('getCompany') }}" class="d-flex align-items-center gap-3 py-2 active">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                        fill="none">
                        <path
                            d="M10 0C4.48 0 0 4.48 0 10C0 15.52 4.48 20 10 20C15.52 20 20 15.52 20 10C20 4.48 15.52 0 10 0ZM10 18C5.59 18 2 14.41 2 10C2 5.59 5.59 2 10 2C14.41 2 18 5.59 18 10C18 14.41 14.41 18 10 18Z"
                    ...
                    <div class="top bg-white p-4 mb-5">
                        ...
                        <div action="" class="group1">
                            ...
                            <label for="img">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                    ...
                                    <circle cx="12.5" cy="12.5" r="12.5" fill="#2D3245" />
                                    <path
                                        d="M18.5 7.25024H16.1225L14.75 5.75024H10.25L8.8775 7.25024H6.5C5.675 7.25024 5 7.92524 5 8.75024V17.7502C5 18.5752 5.675 19.2502 6.5 19.2502H18.5C19.325 19.2502 20 18.5752 20 17.7502V8.75024C20 7.92524 19.325 7.25024 18.5 7.25024ZM18.5 17.7502H6.5V8.75024H9.5375L10.91 7.25024H14.09L15.4625 8.75024H18.5V17.7502ZM12.5 9.50024C10.43 9.50024 8.75 11.1802 8.75 13.2502C8.75 15.3202 10.43 17.0002 12.5 17.0002C14.57 17.0002 16.25 15.3202 16.25 13.2502C16.25 11.1802 14.57 9.50024 12.5 9.50024ZM12.5 15.5002C11.2625 15.5002 10.25 14.4877 10.25 13.2502C10.25 12.0127 11.2625 11.0002 12.5 11.0002C13.7375 11.0002 14.75 12.0127 14.75 13.2502C14.75 14.4877 13.7375 15.5002 12.5 15.5002Z"
                                        fill="white" />
                                </svg>
                            </label>

                            <input id="img" type="file" class="d-none" name="photo">
                        ...
                        <div action="" class="group2 mb-4">
                            ...
                            <div class="line d-flex justify-content-between gap-3 mb-4">
                                ...
                                <div class="input d-flex flex-column gap-2">
                                    ...
                                    <input name="companyName" type="text" placeholder="Company Name"
                                        class="p-3 @error('companyName') is-invalid @enderror"
                                        value="{{ old('companyName') }}" required autocomplete="companyName">
                                ...
                                <div class="input d-flex flex-column gap-2">
                                    ...
                                    <input name="PersonName" type="text" placeholder="Contact Person Name"
                                        class="p-3 @error('PersonName') is-invalid @enderror"
                                        value="{{ old('PersonName') }}" required autocomplete="PersonName">
                            ...
                            <div class="line d-flex justify-content-between gap-3 mb-4">
                                ...
                                <div class="input kk d-flex flex-column gap-2 w-50">
                                    <label>address line</label>

                                    <input name="address" type="text" placeholder="Add Address"
                                        class="p-3 @error('address') is-invalid @enderror"
                                ...
                                <div class="input d-flex flex-column gap-2 ">
                                    <label>country</label>
                                    <select name="country_id" id="" class="p-3">
                                ...
                                <div class="input d-flex flex-column gap-2 ">
                                    <label>City</label>
                                    <select name="city_id" id="" class="p-3">
                                        <option value="" disabled selected>Choose</option>
                            ...
                            <div class="line d-flex justify-content-between gap-3 mb-4">
                                <div class="input d-flex flex-column gap-2">
                                    ...
                                    <input name="companyEmail" type="email" placeholder="ex. gleem@email.com"
                                        class="p-3 @error('companyEmail') is-invalid @enderror"
                                ...
                                <div class="input d-flex flex-column gap-2">
                                    ...
                                    <input name="personEmail" type="email" placeholder="ex. gleem@email.com"
                                        class="p-3 @error('personEmail') is-invalid @enderror"
                                        value="{{ old('personEmail') }}" required autocomplete="personEmail">
                            ...
                            <div class="line d-flex justify-content-between gap-3 mb-4">
                                <div class="input d-flex flex-column gap-2">
                                    ...
                                    <input name="mobPhone" type="number" placeholder="Mobile Phone"
                                        class="p-3 @error('mobPhone') is-invalid @enderror"
                                        value="{{ old('mobPhone') }}" required autocomplete="mobPhone">
                                ...
                                <div class="input d-flex flex-column gap-2">
                                    ...
                                    <input name="companyPhone" type="number" placeholder="Company Phone"
                                        class="p-3 @error('companyPhone') is-invalid @enderror"
                                        value="{{ old('companyPhone') }}" required autocomplete="companyPhone">
                                ...
                                <div class="input d-flex flex-column gap-2">
                                    ...
                                    <input name="workPhone" type="number" placeholder="Work Phone"
                                        class="p-3 @error('workPhone') is-invalid @enderror"
                                        value="{{ old('workPhone') }}" required autocomplete="workPhone">
