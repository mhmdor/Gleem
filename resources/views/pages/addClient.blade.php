...
<body>
  ...
  <div class="overview clients d-flex">
    ...
    <div class="page">
      ...
      <div class="add-client pt-4 ps-3 pe-5 mb-5">

        <h2 class="d-flex align-items-center gap-2 mb-4 pt-2">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
            <path d="M8 10C5.32571 10 0 11.3371 0 14V16H16V14C16 11.3371 10.6743 10 8 10ZM2.67429 13.7143C3.63429 13.0514 5.95429 12.2857 8 12.2857C10.0457 12.2857 12.3657 13.0514 13.3257 13.7143H2.67429ZM8 8C10.2057 8 12 6.20571 12 4C12 1.79429 10.2057 0 8 0C5.79429 0 4 1.79429 4 4C4 6.20571 5.79429 8 8 8ZM8 2.28571C8.94857 2.28571 9.71429 3.05143 9.71429 4C9.71429 4.94857 8.94857 5.71429 8 5.71429C7.05143 5.71429 6.28571 4.94857 6.28571 4C6.28571 3.05143 7.05143 2.28571 8 2.28571Z" fill="#2D3245"/>
            </svg>
            Add new client
        </h2>
          ...
          <div class="top bg-white p-4 mb-5">
            ...
            <div action="" class="group1">
              ...
              <div class="line d-flex justify-content-between gap-3 mb-4">
                <input type="text" class="p-3" placeholder="First Name">
                <input type="text" class="p-3" placeholder="Second Name">
                <input type="text" class="p-3" placeholder="Third Name">
                <input type="text" class="p-3" placeholder="Last Name">
              </div>
              ...
              <div class="line d-flex justify-content-between gap-3 mb-4">
                ...
                <div class="input d-flex flex-column gap-2">
                  ...
                  <input type="date" name="" id="" class="p-3">
                </div>
                <div class="input d-flex flex-column gap-2">
                  <label>estimated age</label>
                  <div class="two d-flex gap-2">
                    <input type="number" placeholder="Year" class="p-3 w-25">
                    <input type="number" placeholder="Month" class="p-3 w-25">
                  </div>
                </div>
                <div class="input d-flex flex-column gap-2">
              ...
              <div class="line d-flex justify-content-between gap-3">
                <div class="two d-flex gap-3 w-50">
                  ...
                  <div class="input d-flex flex-column gap-2 w-50">
                    <label>ID</label>
                    <select name="" id="" class="p-3">
                      <option value="" disabled selected>ex. national ID, Passport,etc</option>
                ...
                <div class="input d-flex flex-column gap-2">
                  ...
                  <input type="number" placeholder="Add ID number" class="p-3">
                </div>
              </div>
            ...
            <div action="" class="group2 mb-4 w-75">
              ...
              <div class="line d-flex justify-content-between gap-3 mb-4">
                <div class="input d-flex flex-column gap-2">
                  ...
                  <input type="text" class="p-3" placeholder="Add address">
                </div>
              </div>
              <div class="line d-flex justify-content-between gap-3 mb-4">
                <div class="input d-flex flex-column gap-2">
                  <label>Mobile</label>
                  <input type="number" class="p-3">
                </div>
                <div class="input d-flex flex-column gap-2">
              ...
              <div class="line d-flex justify-content-between gap-3 mb-4">
                <div class="input d-flex flex-column gap-2">
                  <label>Email</label>
                  <input type="text" class="p-3" placeholder="ex. gleem@email.com">
                </div>
              </div>
            </div>
          ...
          <div class="bottom d-flex align-items-center justify-content-between">
            <div class="clear d-flex align-items-center">
              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="18" viewBox="0 0 14 18" fill="none">
                <path d="M11 6V16H3V6H11ZM9.5 0H4.5L3.5 1H0V3H14V1H10.5L9.5 0ZM13 4H1V16C1 17.1 1.9 18 3 18H11C12.1 18 13 17.1 13 16V4Z" fill="currentColor"/>
                </svg>
