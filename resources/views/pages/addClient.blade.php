                            ...
                            <div class="line d-flex justify-content-between gap-3 mb-4">
                                ...
                                <div class="input d-flex flex-column gap-2">
                                    ...
                                    <select name="gender" id=""
                                        class="p-3 @error('gender') is-invalid @enderror">
                            ...
                            <div class="line d-flex justify-content-between gap-3 mb-4">
                                ...
                                <div class="input d-flex flex-column gap-2">
                                    ...
                                    <input type="date" name="dBirth" id=""
                                        class="p-3 @error('dBirth') is-invalid @enderror">
                                    @error('dBirth')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="input d-flex flex-column gap-2">
                                    ...
                                    <select name="religion" id=""
                                        class="p-3 @error('religion') is-invalid @enderror">
                                        <option value="" disabled selected>Choose</option>
                            ...
                            <div class="line d-flex justify-content-between gap-3 mb-4">
                                ...
                                <div class="input d-flex flex-column gap-2">
                                    ...
                                    <select name="region" id=""
                                        class="p-3 @error('region') is-invalid @enderror">
                                        <option value="" disabled selected>Choose</option>
                            ...
                            <div class="line d-flex justify-content-between gap-3 mb-4">
                                ...
                                <div class="input d-flex flex-column gap-2">
                                    ...
                                    <input name="email" type="text"
                                        class="p-3 @error('email') is-invalid @enderror"
                                        placeholder="ex. gleem@email.com">
                                    @error('email')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
