    ...
    <div class="overview clients d-flex">
      ...
      document.getElementById('logout-form').submit();">
        ...
        <div class="page">
            ...
            <div class="company-details pt-4 ps-3 pe-5 d-flex gap-3 mb-5">
                <div class="content bg-white p-4 w-100">
                    <div class="name pb-3 d-flex align-items-center justify-content-between w-100">
                        ...
                        <div class="tools d-flex align-items-center gap-4">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15"
                                ...
                                <path
                                    d="M13.4672 0.461914H2.26719C1.49719 0.461914 0.867188 1.09191 0.867188 1.86191V14.4619L3.66719 11.6619H13.4672C14.2372 11.6619 14.8672 11.0319 14.8672 10.2619V1.86191C14.8672 1.09191 14.2372 0.461914 13.4672 0.461914ZM13.4672 10.2619H3.66719L2.26719 11.6619V1.86191H13.4672V10.2619Z"
                                    fill="currentColor" />
                            </svg>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15"
                                viewBox="0 0 15 15" fill="none">
                                <path
                                    d="M2.01316 13.1753H2.85354L11.3147 4.71419L10.4743 3.87381L2.01316 12.3349V13.1753ZM13.7403 3.89291L11.2956 1.44816L12.0977 0.645982C12.3142 0.42952 12.5816 0.321289 12.8999 0.321289C13.2183 0.321289 13.4856 0.42952 13.7021 0.645982L14.5425 1.48636C14.759 1.70283 14.8672 1.97022 14.8672 2.28855C14.8672 2.60687 14.759 2.87427 14.5425 3.09073L13.7403 3.89291ZM12.9381 4.69509L3.31193 14.3213H0.867188V11.8765L10.4934 2.25035L12.9381 4.69509ZM10.8945 4.294L10.4743 3.87381L11.3147 4.71419L10.8945 4.294Z"
                                    fill="currentColor" />
                            </svg>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="12" height="15"
                                ...
                                <path
                                    d="M9.42274 5.19936V12.7411H3.20052V5.19936H9.42274ZM8.25608 0.674316H4.36719L3.58941 1.42849H0.867188V2.93684H11.7561V1.42849H9.03385L8.25608 0.674316ZM10.9783 3.69101H1.64497V12.7411C1.64497 13.5707 2.34497 14.2494 3.20052 14.2494H9.42274C10.2783 14.2494 10.9783 13.5707 10.9783 12.7411V3.69101Z"
                                    fill="currentColor" />
                            </svg>

                        </div>
                    </div>
                    <div class="image-data d-flex align-items-center gap-3 py-4">
                        <div class="image"><img src="{{ asset('assets/uploads/logos/' . $Company->photo) }}"
                                alt=""></div>
                    ...
                    <div class="info pt-4 pb-5">
                        ...
                        <div class="row">
                            <div class="col-6 d-flex gap-4">
                                <div class="keys d-flex flex-column gap-3">
                                ...
                                <div class="values d-flex flex-column gap-3">
                                    <li>{{ $Company->PersonName }}</li>
                                    <li>{{ $Company->mobPhone }}</li>
                                    <li>{{ $Company->companyPhone }}</li>
                                    <li>{{ $Company->created_at }}</li>
                                    <li>{{ $Company->companyEmail }}</li>
                                    <li>{{ $Company->personEmail }}</li>
                                </div>
                            </div>
                            <div class="col-6 d-flex gap-4 ps-4">
                                <div class="keys d-flex flex-column gap-3">
