...
document.getElementById('logout-form').submit();">
        ...
        <div class="page">
            ...
            <div class="client-details pt-4 ps-3 pe-5 mb-5">
                <h2 class="mb-4">Client details</h2>
                <div class="details bg-white p-3">
                    <div class="first d-flex align-items-center justify-content-between pb-3">
                        <span>{{ $Client->idNumber }}</span>
                        <div class="tools d-flex align-items-center gap-4">
                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="15"
                                viewBox="0 0 14 15" fill="none">
                                <path
                                    d="M1.14598 13.354H1.98636L10.4475 4.89291L9.60709 4.05252L1.14598 12.5136V13.354ZM12.8731 4.07162L10.4284 1.62688L11.2306 0.824693C11.447 0.608231 11.7144 0.5 12.0327 0.5C12.3511 0.5 12.6185 0.608231 12.8349 0.824693L13.6753 1.66507C13.8918 1.88154 14 2.14893 14 2.46726C14 2.78558 13.8918 3.05298 13.6753 3.26944L12.8731 4.07162ZM12.0709 4.87381L2.44475 14.5H0V12.0553L9.62619 2.42906L12.0709 4.87381ZM10.0273 4.47271L9.60709 4.05252L10.4475 4.89291L10.0273 4.47271Z"
                                    fill="#2D3245" />
                            </svg>
                            <svg xmlns="http://www.w3.org/2000/svg" width="11" height="15"
                                viewBox="0 0 11 15" fill="none">
                                <path
                                    d="M8.55556 5.16667V12.9444H2.33333V5.16667H8.55556ZM7.38889 0.5H3.5L2.72222 1.27778H0V2.83333H10.8889V1.27778H8.16667L7.38889 0.5ZM10.1111 3.61111H0.777778V12.9444C0.777778 13.8 1.47778 14.5 2.33333 14.5H8.55556C9.41111 14.5 10.1111 13.8 10.1111 12.9444V3.61111Z"
                                    fill="#E7511D" />
                            </svg>
                        </div>
                    </div>
                    <div class="second d-flex align-items-center justify-content-between py-4">
                        <div class="data d-flex flex-column gap-2">
                            <h2>{{ $Client->fName }} {{ $Client->sName }} {{ $Client->lName }}</h2>
                            <h3>{{ $Client->idNumber }}</h3>
                        </div>
                        <a href="/">Send massage</a>
                    </div>
                    <div class="third pt-3 pb-4">
                        ...
                        <div class="row">
                            <div class="col-6 d-flex gap-5">
                                ...
                                <div class="values d-flex flex-column gap-3">
                                    <li>{{ $Client->fName }} {{ $Client->sName }} {{ $Client->lName }}</li>
                                    <li>{{ $Client->gender }}</li>
                                    <li>{{ $Client->dBirth }} </li>
                                </div>
                            </div>
                            <div class="col-6 d-flex gap-5">
                                ...
                                <div class="values d-flex flex-column gap-3">
                                    <li>{{$nationality}}</li>
                                    <li>{{ $Client->religion }}</li>
                                </div>
                            </div>
                        </div>
                    </div>

                    <div class="fifth pt-3 pb-4">
